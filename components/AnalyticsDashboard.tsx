...
import { 
  ...
  CheckCircle, FileText, DownloadCloud, Play,
  Clock, Activity, Shield, History, Search, User, Eye, Lock,
...
const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({ currentUser }) => {
  ...
  // Obter logs reais, filtrar e ordenar
  const myLogs = useMemo(() => {
    const rawLogs = auditLogger.getLogsByUser(currentUser.id);
  ...
  }, [currentUser.id, sortKey, sortDirection]);
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center gap-1.5 mt-4">
              <span className="flex items-center gap-1 text-[11px] font-black text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-lg">
                <ArrowUpRight className="w-3 h-3" /> 12% mais rápido
              </span>
              <span className="text-[10px] font-bold text-slate-400">vs mês anterior</span>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center gap-1.5 mt-4">
              <span className="flex items-center gap-1 text-[11px] font-black text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-lg">
                <ArrowUpRight className="w-3 h-3" /> 3.2% aumento
              </span>
              <span className="text-[10px] font-bold text-slate-400">vs mês anterior</span>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center gap-1.5 mt-4">
              <span className="flex items-center gap-1 text-[11px] font-black text-red-600 bg-red-50 px-2 py-0.5 rounded-lg">
                <ArrowDownRight className="w-3 h-3" /> 5% queda
              </span>
              <span className="text-[10px] font-bold text-slate-400">vs mês anterior</span>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center gap-1.5 mt-4">
              <span className="flex items-center gap-1 text-[11px] font-black text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-lg">
                <ArrowUpRight className="w-3 h-3" /> 1.5% aumento
              </span>
              <span className="text-[10px] font-bold text-slate-400">vs mês anterior</span>
            </div>
          </div>
      ...
      {/* Tabela de Performance por Organização */}
      <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
